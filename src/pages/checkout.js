...
<div className="bg-gray-500">
  ...
  <div
    className="relative grid grid-cols-1 gap-x-16 max-w-7xl mx-auto lg:px-8 lg:grid-cols-2 xl:gap-x-48"
  >
    ...
    >
      <div className="max-w-lg mx-auto lg:max-w-none">
        ...
        <dl
          className="hidden text-sm font-medium text-white space-y-6 border-t border-white pt-6 lg:block"
        >
        ...
        <Popover
          className="fixed bottom-0 inset-x-0 flex flex-col-reverse text-sm font-medium text-white lg:hidden"
        >
          <div
            className="relative z-10 bg-gray-50 border-t border-white px-4 sm:px-6"
          >
    ...
    >
      <div className="max-w-lg mx-auto lg:max-w-none">
        ...
        <div
          className="mt-10 pt-6 border-t border-white sm:flex sm:items-center sm:justify-between"
        >
          <button
            type="submit"
          ...
          <p
            className="mt-4 text-center text-sm text-white sm:mt-0 sm:text-left"
          >

...
const features = [
  ...
  },
  {
    name: "Cows",
    description:
      "40 cows placed in the yard of an unsuspecting friend or family member.",
  },
  {
  ...
  },
  {
    name: "Time Period",
    description:
      "The Herd will stay in the yard with the sign for 7 days and includes delivery and pickup.",
  },
];
const { products } = data;
        ...
        <div className="max-w-2xl mx-auto pt-16 pb-24 px-4 sm:pb-32 sm:px-6 lg:max-w-7xl lg:pt-32 lg:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">
          <div className="lg:col-start-2">
            ...
            <dl className="mt-10 grid grid-cols-1 gap-y-10 gap-x-8 text-sm sm:grid-cols-2">
              ...
              <a
                className="bg-blue-600 text-white hover:opacity-75 p-2 rounded-xl text-center"
                href="/CowPack"
              >
                Previous Package
              </a>

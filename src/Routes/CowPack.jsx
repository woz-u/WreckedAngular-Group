...
const features = [
  ...
  },
  {
    name: "Cows",
    description:
      "30 cows placed in the yard of an unsuspecting friend or family member.",
  },
  {
  ...
  },
  {
    name: "Time Period",
    description:
      "The Herd will stay in the yard with the sign for 5 days and includes delivery and pickup.",
  },
];

export default function CowPack() {
  return (
      ...
      <section aria-labelledby="features-heading" className="relative">
        ...
        <div className="max-w-2xl mx-auto pt-16 pb-24 px-4 sm:pb-32 sm:px-6 lg:max-w-7xl lg:pt-32 lg:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">
          <div className="lg:col-start-2">
            ...
            <p className="mt-4 text-4xl font-extrabold text-indigo-600 tracking-tight">
              Cow Pack
            </p>
            <p className="mt-4 text-gray-500">
              This Package is great for someone with a regular sized yard that
              you want to congratulate or just give a good laugh to.
            </p>
